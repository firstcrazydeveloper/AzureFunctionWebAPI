namespace SampleAzureFunctionCode
{
    using System;
    using System.IO;
    ...
    {
        [HttpGet]
        [FunctionName(nameof(GetDataAsync))]
        ...
        [HttpGet]
        [FunctionName(nameof(GetAgentsAsync))]
        ...
        [HttpGet]
        [FunctionName(nameof(GetMessagePipelineAsync))]
        public async Task<IActionResult> GetMessagePipelineAsync(
            [HttpTrigger(AuthorizationLevel.Function, "GET", Route = "agents")] HttpRequest req,
            ILogger log)
        {
            log.LogInformation("C# HTTP trigger function processed a request.");
